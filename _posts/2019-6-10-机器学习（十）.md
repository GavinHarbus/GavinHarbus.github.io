...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v6tqtqlvj30g4055q5m.jpg)
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v6ulcrmhj30g805mq4k.jpg)  
Heaviside阶跃函数：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v6vhl0r5j30ax02f0sw.jpg)
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v72d5zq7j30g706dgnq.jpg)  
如图是一个两个输入，三个输出的感知器，它可以将实例同时分为三个不同的二进制类，因此它也是多输出分类器。  
感知器学习规则（权重更新）：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v75co9tnj306x018q2y.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v7k9ofdtj30g807n776.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v7vnvohhj303x00i0sp.jpg)  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v7vy8j6nj304600iaa1.jpg)  
**MLP常常用作分类，每个输出对应一个不同的二进制分类。当每个分类是互斥的情况下，输出层通常被修改为一个共享的soft-max函数**  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3v7yncjasj30g508mtcf.jpg)  
...
```  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3w2xa0g2ij30rl0b0q6j.jpg)  
训练结束，进行预测！  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3w2ztyk4ej30qy04jgn2.jpg)  
准确率颇高！
