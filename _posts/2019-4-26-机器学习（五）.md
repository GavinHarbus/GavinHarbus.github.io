...
#### 基本理论
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2eokpdi8hj30fv03zwh0.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2eotf21buj30fw04ctav.jpg)  
SVM对*特征缩放*很敏感，如上图所示，缩放后，街道距离明显加宽，决策边界看起来好了很多。  

#### 软间隔分类
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2ep3rb5n6j30fx03ntb7.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2epdhi6k9j30fx04nad3.jpg)
...
#### 基本理论
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2ew5a2dnsj30g506iq5j.jpg)  
...
```  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2ewf01jj8j30fw0ahjzg.jpg)  
...
```  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2ewmmo7hpj30g5061wjo.jpg)  
*PS：如果过拟合，降低多项式参数；如果欠拟合，提高多项式参数。超参数coef0用与控制模型接受多项式影响的程度*  

#### 添加相似特征
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2ewu77j2gj30fz05tn0s.jpg)
...
#### 高斯RBF核函数
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2expvjxi0j30fx0a4wny.jpg)
...
#### 基本概念
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fwj74orqj30fx071430.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fwrq8y0ij30fx07043p.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fx8ev7yuj304w020mx6.jpg)  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fxnqpqjaj30g309079h.jpg)  
...
#### 训练目标
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fxvvm50bj30fz04dtav.jpg)
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2fy48fg0ij30a602adfz.jpg)  

要达到软间隔的目标，对每个实例引入一个*松弛变量*\\(\zeta^i \geq 0\\)，其表示第i个实例多大程度上允许间隔违例，同时还要使\\(\frac{1}{2} w^T \cdot w\\) 最小化以增大间隔。这正是超参数C的意义。软间隔约束优化目标是：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g2d7fukpj30dk02kglv.jpg)  

#### 二次规划
硬间隔和软间隔问题都是属于线性约束的**凸二次优化问题**，即**二次规划（QP）**问题。此问题一般形式如下：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g2jprtznj30eo06ct9h.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g2r1e914j30ak02lt8x.jpg)  
一旦利用二次规划求解器得到使该等式最小化的向量\\(\hat{a}\\)，便可以利用以下公式来求得原始问题的最小化的\\(\hat{w}\\)和\\(\hat{b}\\)。  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g2uywliwj306u03aq33.jpg)  

*PS:当训练实例数量小于特征数量时，解决对偶问题比原始问题更快*  

#### 核化SVM
如果我们想将一个二姐多项式转换成一个二维训练集，然后在转换训练集上训练线性SVM分类器，假设转换函数\\(\phi\\)如下：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3cswu4sj305i035q31.jpg)  
转换后的向量是三维的，而不是二维的，如果两个二维向量进行映射会如何？  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3ecem4gj30ct04vdga.jpg)  
...
如下是一些常用的核：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3rnouw4j3094042t94.jpg)  

使用核化SVM作出预测：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3w9iqjgj30ct04tq3g.jpg)  
使用核化SVM计算偏置项：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3x01fkuj30fc04qdgf.jpg)  

#### 在线SVM
对于线性SVM来说，增量训练可以使用梯度下降进行成本函数最小化，但速度比二次规划慢很多。成本函数如下：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g2g3zplpnyj30b701lt8t.jpg)  
