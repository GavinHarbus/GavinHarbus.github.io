...
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g124cnmu5zj30xl0dmttk.jpg)

#### 下载并预览数据

下载并解压数据  
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g124kl61a7j305i02uq32.jpg)  
预览数据  
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g124l0kzvdj30ys065tag.jpg)  
...
1. 读取数据
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g125gmao57j30tg0eqn1g.jpg)  
...
2. 查看数据结构和描述  
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g1264mu250j30aq0fi762.jpg)  
...
3. 查看数据基本情况  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g1280os6toj30hq0k1whv.jpg)  
	查看数据频数直方分布情况  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g1284fam3oj31400u0dk7.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g128ln0yuvj31400u0wio.jpg)
...
1. 将地理数据可视化  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g128vmpmh6j30fo0avajn.jpg)
   ![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g128u9drfmj30hs0dcaaj.jpg)  
   改变alpha参数，观察实例分布密度  
   ![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g128zsvp0ej30hs0dcmxv.jpg)  
   不得不说，帝都房价就是厉害，每个地区房屋成交量都很巨大。
2. 将区域、房价信息可视化  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g1296qdg9dj30hs0dcjt7.jpg)  
	图中每个圆的半径代表价格，颜色代表各区域，基本了解数据中房源的区域集中情况。  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g129dsncdnj30hs0dcabt.jpg)  
...
3. 绘制价格随时间变化图
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g12lv4rj49j30hs0dcq3b.jpg)  
	帝都房价10年开始狂飙突进，18年倒有下降趋势  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g12nschehpj315o0rsq4z.jpg)  
...
4. 探索房子建筑年限与房价的关系  
	...
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13jltdxayj30hs0dc3yx.jpg)  
	百年老房，就是不同凡响！  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14gie4a32j31400u0jtm.jpg)  
	发现百年老房只是个例，房龄集中在0～65年附近，放大图像进行细微观察  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14gjja60lj31400u0n4i.jpg)  
...
5. 探索房价与面积关系
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14fftn79sj30hs0dc74q.jpg)
	可见1000平以上的豪宅价格飙升，600～900平又是一个上升区间，0～400平应该属于刚需部分，400～600平价格基本稳定，但有可能是样本数量问题，因此我决定再看看整体情况
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14fpyoopxj31400u074q.jpg)  
	发现面积很集中，缩小区间再观察一下  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14fspbswuj31400u0jru.jpg)  
	北京楼市交易成功的房产大多是100平及以下的房子  
	看一下面积与价格的情况  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14gc213vjj31400u0dhj.jpg)  
	发现基本是面积越大，价格越高  
	放大坐标进行观察  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14go4f4q6j31400u041f.jpg)  
	...
	```
6. 探索时间、面积与房价的关系
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14isll0lzj30hs0dcq3v.jpg)
	市面上交易的北京房产大多集中在0～2500w左右，0～500平之间  
	放大坐标  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14ixuc6ijj30hs0dc0tt.jpg)  
	再度放大坐标  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14j15guqbj30hs0dcgnl.jpg)  
...
7. 检查是否存在脏数据  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13l1zcongj309g06paah.jpg)  
	livingRoom存在#NAME？考虑删除
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13l3xvw5lj309m09rt9a.jpg)
	drawingRoom存在中文、数值混杂，混杂的中文也不多，考虑删除  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13l5v885cj308q0a30ta.jpg)  
	bathRoom存在明显错误，考虑删除错误记录  
	floor属性很混乱，需要特别处理
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13ld5m1fmj309o06idg9.jpg)  
	buildingType也存在错误  
	经检查，需要处理的属性如下：  
	**constructionTime**  
	**buildingType**  
...
2. 清洗结果还比较理想
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13qfggbyqj30aq0cngmz.jpg)  
3. 用众数填补缺失值
...
1. 线性回归模型
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13ruf9bdqj30hw02sdgc.jpg)  
	效果理想
2. 决策树  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g13td8eobbj30ht02naaj.jpg)  
	效果也算理想，但是训练时间过久，考虑减少一些无关特征。  
	查看特征之间相关性  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14dvm57ezj30u00u044g.jpg)  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14e1g9il6j307q08nab2.jpg)  
	发现与价格相关性最高的还是面积、社区均价，但是我们是要预测一套房子的价格，因此选取的特征最好是房子本身的属性，我考虑删除followers、communityAverage  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14ej5s0j7j30hs02k0t7.jpg)  
	减少特征之后的线性回归模型性能仍可以接受  
	
3. 线性SVR
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14j84zrcvj30ht02mgm4.jpg)  

4. 调参  
	由于我的计算机算力实在不济，所以只能先使用线性模型进行练手了
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14m6noctsj30b6014wek.jpg)  
	得到线性svr的最佳参数  
	查看每次的RMSE  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14m85mtbmj30h704hq40.jpg)  
	结果可以接受
...
1. 利用测试集进行验证  
![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14mct7qwyj304c011q2y.jpg)   
	效果与训练集差不多，可以接受
2. 从测试集中随机取100个记录进行预测，查看效果  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14mvjl7hyj30hs0dc752.jpg)  
	可见预测结果几乎吻合，因此模型可以使用
	...
	```
3. 导出模型  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tKfTcly1g14mylxi5cj303803bmx7.jpg)
