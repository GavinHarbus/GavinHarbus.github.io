...
![](https://crescentrose.blob.core.windows.net/blog-img/007S8ZIlgy1gdq5615cdbj30i109eq4c.jpg)  
...
+ HTTP重定向  
	...
	![](https://crescentrose.blob.core.windows.net/blog-img/007S8ZIlgy1gdq5n4xumcj30g30ce41a.jpg)
+ DNS负载均衡  
	DNS服务器将请求的域名映射到实际的ip上，可以是一对多，这样DNS服务器便可执行负载均衡的功能（默认是轮询策略）
	![](https://crescentrose.blob.core.windows.net/blog-img/007S8ZIlgy1gdq5nlr6ocj30ge0cldin.jpg)
+ 反向代理  
	利用反向代理服务器转发请求
	![](https://crescentrose.blob.core.windows.net/blog-img/007S8ZIlgy1gdq5o5uoyzj30ha0crtbe.jpg)