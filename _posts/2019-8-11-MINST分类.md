...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vs9dn5hgj30fy078tbj.jpg)  
...
1. 准备输入
	...
	```
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vsoccqelj30hs0dc3yg.jpg)
	图片尺寸：28*28
2. 第一个卷积层
	...
	```  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vsp453nfj30hs0dcq2w.jpg)
	图片尺寸：28*28，32个特征生成
3. 第二个卷积层
	...
	```
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vssfv0nsj30hs0dcmx3.jpg)
	图片尺寸：14*14，64个特征生成
4. 池化层
	...
	```  
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vsupxd5gj30hs0dcgli.jpg)
	图片尺寸：7*7，64个特征  
	并将其合并为一列，为连接层准备
5. 连接层与输出层
...
9. 开始训练
	...
	```
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vulbfzurj30bd055mxj.jpg)
	
#### 查看训练情况

![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vuonru55j30lt0c7wfr.jpg)
可知训练陷入震荡状态  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vusjea1ej312f0u0jwx.jpg)  
计算图如上所示  
初步怀疑出现震荡是训练度不够，因此尝试再训练一个轮回，看看结果。  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vvq8rbhnj30ba054aag.jpg)  
有所提升
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vvt8ofvrj30jx0c10u4.jpg)  
损失函数也出现了下降  
又训练了一轮，发现始终在震荡  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5vxh2hba4j30ph0bwgna.jpg)
...
绘制混淆矩阵  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5wvq0qoyxj30u00u00v4.jpg)  
绘制错误率矩阵
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g5wvqlvimij30u00u0gnh.jpg)  
可知8很容易和其他数字混淆  
