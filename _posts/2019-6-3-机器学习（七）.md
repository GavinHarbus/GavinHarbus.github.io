...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o0dtzlvmj30g008rdjq.jpg)  
...
```  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o24qhxhoj30fw05udli.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o5scq12fj30fy09h0yo.jpg)  
*PS:这种方法的缺点是无法并行，新的预测器只能依赖前一个预测器*  

AdaBoost算法，每个实例的初始权重为1/m，第一个预测器训练后，计算其**加权误差率**：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o5ysgnqpj30fl03m0t0.jpg)  
**预测器权重**：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o5zy2sgmj304101nweg.jpg)  
**权重更新规则**：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o60n1vr4j308003uglv.jpg)  
预测的时候，AdaBoost计算所有预测器结构，并对它们进行加权，最后大多数加权投票的结果类别就是预测类别。  
**预测**：  
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o62y4795j30cj037t8z.jpg)  
...
![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o6w65x0gj30g3097go1.jpg)  
步骤如下：  

1. 先将训练集拆分为两个子集，第一个子集用于训练第一层的预测器
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o72rn68aj30fx06owh1.jpg)
2. 用第一层的预测器在第二个子集（留存集）上进行预测，得到新特征
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o7371218j30fy0a3424.jpg)
3. 在第二个子集得到的新特征上创建新的预测器
	![](https://crescentrose.blob.core.windows.net/blog-img/006tNc79ly1g3o73k5rkqj30fz0a6424.jpg)  
